...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2018 a las 19:00:17
...
--
ALTER TABLE `calificacion`
  MODIFY `id_calificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `descripcion_calificacion`
  MODIFY `id_descripcion_calificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `maestro`
  MODIFY `id_maestro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
